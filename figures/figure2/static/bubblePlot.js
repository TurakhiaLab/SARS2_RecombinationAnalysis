import { csvToArray, getMonthsCollection } from "./util.js";
import { bindAxis, addCurve, addArea, addLegend } from "./plotUtil.js";

async function bubblePlot(svg, config) {
  ...
  const statData = await d3.csv(config["statsFilename"]);
